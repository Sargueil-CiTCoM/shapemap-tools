...
def comparison(self):
    ...
    response1 = input("Please enter DBM filename/address of the first model : ")
    while response1.split('.')[1].upper() != 'DBN':
        response1 = input("Please enter DBM filename/address of the first model : ")

    if response1.split('.')[1].upper() == 'DBN':
        filename1 = f'{response1}'
        response2 = input("Please enter DBM filename/address of the second model : ")
        while response2.split('.')[1].upper() != 'DBN':
            response2 = input("Please enter DBM filename/address of the second model : ")
        if response2.split('.')[1].upper() == 'DBN':
            filename2 = f'{response2}'
